...
// Otra forma directa, pero no recomendada por riegos de inyección de SQL
// Se ejecuta directamente
// $stmt = $dbh->query("SELECT * FROM Usuarios ");

// 3) Especifico la forma de reperar los datos.
// POR DEFECTO ES PDO::FETCH_BOTH Asociativa y numérica 
...
echo "<br> E ) Mediante clase Propia con getter<br>";
echo " <table border=1><tr><th>login</th><th>nombre</th><th>password</th><th>Comentario</th></tr>";

// La clase debe tener los atributos con el mismo nombre
// Obtengo una tabla con todos los datos;
$tobj = $stmt->fetchAll(PDO::FETCH_CLASS, "Usuario");
// Recorro la tabla.
foreach ($tobj as $obj) {
	echo "<tr>";
	echo "<td>$obj->login</td>";
