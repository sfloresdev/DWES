...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch ($_REQUEST['consulta']) {
        case 1:
            $respuesta = verresu($db->consulta1(intval($_POST['precio'])));
            break;
        case 2:
            $respuesta = verresu($db->consulta2());
            break;
        case 3:
            $respuesta = verresu($db->consulta3());
            break;
        case 4:
            $respuesta = verresu($db->consulta4());
            break;
        case 5:
            $respuesta = verresu($db->consulta5(intval($_POST['cliente'])));
            break;
    }
}
